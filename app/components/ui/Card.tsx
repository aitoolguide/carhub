...
const Card = React.forwardRef<HTMLDivElement, CardProps>(({ className, children, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-lg border bg-card text-card-foreground shadow-sm transition-transform transition-shadow duration-1000 ease-in-out',
      'hover:shadow-lg hover:-translate-y-1 hover:border-blue-400',
      className
    )}
    {...props}
  >
